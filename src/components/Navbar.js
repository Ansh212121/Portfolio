              ...
              <nav className="flex w-full bg-blue-600/ backdrop-blur-lg text-white rounded-lg ">
                <div className="px-1 xl:px-4 sm:py-1 flex w-full items-center">
                  <Link className={`text-3xl font-bold font-heading`} to="/">
                    <p className="text-3xl md:text-2xl">AA</p>
                  </Link>
                  ...
                  <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading md:space-x-12">
                    ...
                    <li>
                      <a
                        ...
                        href="https://drive.google.com/file/d/1zX_Z_IcxSi_74Ja9vn-6zAsOcNgmiBAn/view?usp=drive_link"
                        target="_blank"
                        rel="noreferrer"
                      >
                    ...
                    <ul className="flex flex-col items-center font-semibold font-heading space-y-8">
                      ...
                      <li>
                        <a
                          ...
                          href="https://drive.google.com/file/d/1TsJ3fROWG6SrKHuK7jyDtx_p6wmpxAln/view?usp=sharinhttps://drive.google.com/file/d/1TsJ3fROWG6SrKHuK7jyDtx_p6wmpxAln/view?usp=sharingghttps://drive.google.com/file/d/1TsJ3fROWG6SrKHuK7jyDtx_p6wmpxAln/view?usp=drive_link"
                          target="_blank"
                          rel="noreferrer"
                        >
                          <CgFileDocument className="mr-1 text-xl" /> Resume
