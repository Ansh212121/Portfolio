                ...
                <div className="">
                  <blockquote className="blockquote px-2 sm:px-5 mb-0">
                    <p className="text-justify">
                      Hello, I'm Ansh Agarwal, a final year Student in{" "}
            ...
            <div className="flex flex-wrap justify-center">
              <div className="flex flex-col items-center pr-10">
                <div className=" tech-icons">
                  <a
                    href="https://leetcode.com/u/Ansh212121/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <SiLeetcode />
              ...
              <div className="flex flex-col items-center pr-10">
                <div className=" tech-icons">
                  <a
                    href="https://codeforces.com/profile/ansshh"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <SiCodeforces />
              ...
              <div className="flex flex-col items-center ">
                <div className=" tech-icons">
                  <a
                    href="https://www.codechef.com/users/ansh212121"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <SiCodechef />
